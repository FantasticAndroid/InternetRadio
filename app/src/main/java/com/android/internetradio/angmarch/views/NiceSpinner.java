package com.android.internetradio.angmarch.views;
...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        listView = (ListView) LayoutInflater.from(getContext()).inflate(R.layout.spinner_layout_list, null);

        //listView = new ListView(activityContext);
        // Set the spinner's id into the listview to make it pretend to be the right parent in
        // onPodCastSelected
        listView.setId(getId());
        listView.setDivider(new ColorDrawable(getResources().getColor(R.color.popup_divider_color)));
        listView.setDividerHeight(getResources().getDimensionPixelSize(R.dimen.spinner_divider_height));
        ...
        arrowDrawableResId = typedArray.getResourceId(R.styleable.NiceSpinner_arrowDrawable, 0);
    ...
    private Drawable initArrowDrawable(int drawableTint) {
        ...
        try {
            drawable = ContextCompat.getDrawable(getContext(), arrowDrawableResId);
            if (drawable != null) {
    ...
    public void setArrowDrawable(@DrawableRes @ColorRes int drawableId) {
        ...
        arrowDrawable = initArrowDrawable(R.drawable.arrow_nice_spinner);
        setArrowDrawableOrHide(arrowDrawable);
    }
...
//
//        try {
//            heightSpec = MeasureSpec.makeMeasureSpec(((ViewGroup) getParent().getParent()).getMeasuredHeight() - getParentVerticalOffset() / 2 - getMeasuredHeight() - 5,
//                    MeasureSpec.AT_MOST);
//        } catch (Exception e) {
...
//        displayHeight = getContext().getResources().getDimensionPixelSize(R.dimen.spinner_popup_height);
//    }
